...
<body id="cuerpo" class="hold-transition login-page">
...
<div class="login-box">
  ...
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <p class="mb-1">
        <a href="forgot-password.html">Olvid&eacute; mi contraseña</a>
      </p>
      <p class="mb-0">
        <a href="pages/examples/register.html" class="text-center">Registrar una nueva contraseña</a>
      </p>
    </div>
    <!-- /.login-card-body -->
  </div>
